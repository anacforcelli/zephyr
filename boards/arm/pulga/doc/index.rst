...
The Pulga Core board hardware provides support for the 
...
Applications for the ``Pulga`` board configuration can be
built, flashed, and debugged in the usual way.
